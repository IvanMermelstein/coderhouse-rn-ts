...
const App: FC = () => {
    ...
    const [selectedItem, setSelectedItem] = useState<TextList>({ id: 0, value:'' });
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <TouchableOpacity onPress={() => onHandleModal(item)}>
                            <Text style={styles.textList}>{item.id} - {item.value}</Text>
                        </TouchableOpacity>
                    )}
            ...
            >
                <View style={styles.modalContainerContent}>
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.modalContentText}>{selectedItem?.id} - {selectedItem?.value}</Text>
                    </View>
